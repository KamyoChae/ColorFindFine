...
/*   switch (rows) {
        case 10: parseInt(window.innerWidth) < 960 ? boxDiv.style.width = "80%" : boxDiv.style.width = "35%"; break;
        case 14: boxDiv.style.width = "60%"; break;
        case 18: boxDiv.style.width = "75%"; break;
    }
*/
    if (flag) {
